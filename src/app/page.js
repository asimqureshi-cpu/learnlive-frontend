...
export default function LandingPage() {
  return (
    <>
      <Head>
        <title>LearnLive — Real-Time Academic Intelligence</title>
        <meta name="description" content="AI-powered live discussion assessment for case-method seminars. Real-time Bloom's Taxonomy scoring, private student nudges, and instant post-session reports." />
      ...
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ll-nav-cta:hover { background: #2d1f0a !important; color: #f5edd8 !important; }
        ...
        .ll-hero::before {
          ...
          background:
            radial-gradient(ellipse at 20% 50%, rgba(139,105,20,0.18) 0%, transparent 60%),
        ...
        .ll-hero h1 {
          ...
          color: #f5edd8; margin-bottom: 0;
          letter-spacing: -0.02em;
        }
        .ll-hero h1 em { font-style: italic; color: #c9b890; }
        .ll-hero-sub {
          font-size: 1.15rem; color: rgba(245,237,216,0.6);
          max-width: 520px; line-height: 1.65;
          font-weight: 300; margin-top: 1.5rem; margin-bottom: 2.5rem;
        }
        .ll-hero-actions { display: flex; gap: 1rem; flex-wrap: wrap; align-items: center; }
        .ll-btn-primary { background: #c9b890; color: #0e0b06; padding: 0.875rem 2rem; border-radius: 3px; font-size: 0.95rem; font-weight: 500; text-decoration: none; transition: all 0.2s; letter-spacing: 0.01em; display: inline-block; }
        ...
        .ll-btn-primary-dark { background: #1a1208; color: #f5edd8; padding: 0.875rem 2rem; border-radius: 3px; font-size: 0.95rem; font-weight: 500; text-decoration: none; transition: all 0.2s; letter-spacing: 0.01em; display: inline-block; }
        .ll-btn-primary-dark:hover { background: #2d1f0a; }

        .ll-stat-bar {
          margin-top: 4rem;
          border-top: 1px solid rgba(201,184,144,0.15);
          padding-top: 2rem;
        ...
        .ll-logo-pill { font-family: 'DM Sans', sans-serif; font-size: 0.82rem; font-weight: 500; color: #8b7355; padding: 0.35rem 0.875rem; border: 1px solid #d4c9b0; border-radius: 2px; letter-spacing: 0.04em; }
        ...
        /* ── SPLITS ── */
        .ll-split-outer { border-top: 1px solid #e8e0d0; border-bottom: 1px solid #e8e0d0; }
        ...
        .ll-visual::before {
          content: '';
          position: absolute; inset: 0;
          background: radial-gradient(ellipse at 30% 40%, rgba(139,105,20,0.2) 0%, transparent 60%);
          pointer-events: none;
        }
        ...
        .ll-nudge-dot-blue { background: #6494c8; }
        ...
        @media (max-width: 768px) {
          ...
          .ll-diff-outer { padding: 3rem 1.5rem; }
          .ll-quote-outer { padding: 3rem 1.5rem; }
          .ll-usecases-outer { padding: 3rem 1.5rem; }
          .ll-cta-outer { padding: 4rem 1.5rem; }
      ...
      <div>
        ...
        <nav className="ll-nav">
          ...
          <div className="ll-nav-links">
            ...
            <a href="mailto:asim@thebrainsyndicate.com" className="ll-nav-cta">Request a demo</a>
          </div>
        </nav>
        ...
        <div id="how-it-works" style={{ background: '#faf8f4' }}>
          <div className="ll-section">
            ...
            <p className="ll-section-intro">
              Three steps. Your content. Your rubric. AI-powered insight into every student's thinking.
            </p>
            ...
            <div className="ll-visual">
              <div className="ll-visual-inner">
                ...
                <div className="ll-nudge-card">
                  ...
                  <div className="ll-nudge-text">
                    You mentioned the sunk-cost example — but how does Hafenbrack's meditation finding change the decision? What's the mechanism?
                  </div>
                </div>
                <div className="ll-nudge-card-group">
                  <div className="ll-nudge-label">
                    <span className="ll-nudge-dot-blue" style={{ width: '5px', height: '5px', borderRadius: '50%', background: '#6494c8', display: 'inline-block', flexShrink: 0 }}></span>
                    <span className="ll-nudge-label-blue">Discussion prompt</span>
                  </div>
                  <div className="ll-nudge-text">
                    We're in the final minutes — who can summarise the key point of disagreement, and what evidence would change your position?
                  </div>
                </div>
              </div>
            </div>
        ...
        <div id="difference" className="ll-diff-outer">
          <div className="ll-diff-inner">
            ...
            <p className="ll-diff-intro">
              Other platforms evaluate after the session. LearnLive intervenes during it — inside the live seminar, with the professor present.
            </p>
        ...
        <div className="ll-quote-outer">
          <div className="ll-quote-inner">
            <blockquote>
              "The seminar room is where thinking happens. LearnLive makes that thinking measurable — without changing what makes it work."
            </blockquote>
        ...
        <div className="ll-cta-outer">
          <div className="ll-cta-inner">
            ...
            <p>
              LearnLive is currently piloting at Ivey Business School. Request a demo
              to see real-time scoring and AI facilitation in action.
            </p>
            <div className="ll-cta-actions">
              <a href="mailto:asim@thebrainsyndicate.com" className="ll-btn-primary">Request a demo</a>
              <a href="#how-it-works" className="ll-btn-ghost">Read how it works</a>
            </div>
          </div>
        </div>
